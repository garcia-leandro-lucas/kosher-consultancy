<?php
$destino = "garcia.leandrolucas@gmail.com"; // Email del Sitio Web 
$nombre = $_POST["nombre"];
...
if (($nombre != "") && ($email != "")) {
    ...
    header('Location: gracias.html'); // Aca redireccionas a la pagina si esta ok
} else {
	header('Location: error.html'); // Aca redireccionas si hay error
}
?>